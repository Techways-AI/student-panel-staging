...
class DeviceManager {
    ...
    async getOrCreateDeviceUuid() {
        ...
        // Try to get persistent UUID from localStorage
        uuid = localStorage.getItem('persistent_device_uuid');
        
        if (uuid) {
            // Set both device_uuid and cookie for consistency
        ...
        localStorage.setItem('device_uuid', uuid);
        localStorage.setItem('persistent_device_uuid', uuid);
    ...
    clearDeviceData() {
        try {
            ...
            // Clear localStorage (both device_uuid and persistent_device_uuid)
            localStorage.removeItem('device_uuid');
            localStorage.removeItem('persistent_device_uuid');
