...
export async function GET(request) {
  try {
    ...
    console.log('📋 Study Plan API Route: Checking if user has study plan');

    // Forward the request to the backend API
    const response = await fetch(`${API_BASE_URL}/api/study-plan/has-plan`, {
      method: 'GET',
      headers: {
    ...
    console.log('✅ Study Plan API Route: Plan status received:', data);
