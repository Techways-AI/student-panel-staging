...
export async function GET(request) {
  try {
    ...
    console.log('📊 Study Plan API Route: Fetching study plan statistics');

    // Forward the request to the backend API
    const response = await fetch(`${API_BASE_URL}/api/study-plan/stats`, {
      method: 'GET',
      headers: {
    ...
    console.log('✅ Study Plan API Route: Statistics received:', data);
